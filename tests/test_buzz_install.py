...
# Standalone repo layout: tests/ sits next to SKILL.md. (Inside hermes-agent the same
# file lives at tests/skills/ and points at optional-skills/devops/buzz-hermes-profile-setup.)
